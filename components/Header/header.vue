      ...
      <div class=" container ">
        ...
        <div class="d-none d-lg-flex align-items-center mr-3">
          ...
          <a href="/app/dashboard" class="mr-20">
            <img alt="Logo" src="/logo/logo.png" class="max-h-35px"/>
          </a>
          <!--end::Logo-->
          ...
          <!--<div class="dropdown">
            ...
            <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
              <div class="btn btn-icon btn-hover-transparent-white btn-dropdown btn-lg mr-1 pulse pulse-white">
			        				<span class="svg-icon svg-icon-xl">&lt;!&ndash;begin::Svg Icon | path:assets/media/svg/icons/Code/Compiling.svg&ndash;&gt;<svg
                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                        height="24px" viewBox="0 0 24 24" version="1.1">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <rect x="0" y="0" width="24" height="24"/>
...
</svg>&lt;!&ndash;end::Svg Icon&ndash;&gt;</span> <span class="pulse-ring"></span>
              </div>
            </div>
                ...
                <div class="tab-content">
                  ...
                  <div class="tab-pane active show p-8" id="topbar_notifications_notifications" role="tabpanel">
                    ...
                    <span class="symbol-label">
                        <span class="svg-icon svg-icon-lg svg-icon-primary">&lt;!&ndash;begin::Svg Icon | path:assets/media/svg/icons/Home/Library.svg&ndash;&gt;<svg
                          xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                          height="24px" viewBox="0 0 24 24" version="1.1">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <rect x="0" y="0" width="24" height="24"/>
        ...
        <rect fill="#000000" opacity="0.3"
              ...
              x="16.3255682" y="2.94551858" width="3" height="18" rx="1"/>
...
</svg>&lt;!&ndash;end::Svg Icon&ndash;&gt;</span>                    </span>
                        </div>
                    ...
                    <span class="symbol-label">
                        <span class="svg-icon svg-icon-lg svg-icon-warning">&lt;!&ndash;begin::Svg Icon | path:assets/media/svg/icons/Communication/Write.svg&ndash;&gt;<svg
                          xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                          height="24px" viewBox="0 0 24 24" version="1.1">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <rect x="0" y="0" width="24" height="24"/>
        ...
        <path
          ...
          fill="#000000" fill-rule="nonzero" opacity="0.3"/>
                    ...
                    <span class="symbol-label">
                        <span class="svg-icon svg-icon-lg svg-icon-success">&lt;!&ndash;begin::Svg Icon | path:assets/media/svg/icons/Communication/Group-chat.svg&ndash;&gt;<svg
                          xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                          height="24px" viewBox="0 0 24 24" version="1.1">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <rect x="0" y="0" width="24" height="24"/>
        ...
        <path
          ...
          fill="#000000" opacity="0.3"/>
                    ...
                    <span class="symbol-label">
                        <span class="svg-icon svg-icon-lg svg-icon-danger">&lt;!&ndash;begin::Svg Icon | path:assets/media/svg/icons/General/Attachment2.svg&ndash;&gt;<svg
                          xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                          height="24px" viewBox="0 0 24 24" version="1.1">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <rect x="0" y="0" width="24" height="24"/>
        ...
        <path
          ...
          transform="translate(18.035534, 17.863961) scale(1, -1) rotate(45.000000) translate(-18.035534, -17.863961) "/>
                    ...
                    <span class="symbol-label">
                        <span class="svg-icon svg-icon-lg  svg-icon-info">&lt;!&ndash;begin::Svg Icon | path:assets/media/svg/icons/Communication/Shield-user.svg&ndash;&gt;<svg
                          xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                          height="24px" viewBox="0 0 24 24" version="1.1">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <rect x="0" y="0" width="24" height="24"/>
        ...
        <path
          ...
          fill="#000000" opacity="0.3"/>
                      ...
                      <div class="d-flex align-items-center mb-6">
                        ...
                        <div class="symbol symbol-40 symbol-light-danger mr-5">
                    <span class="symbol-label">
                        <span class="svg-icon svg-icon-lg  svg-icon-danger">&lt;!&ndash;begin::Svg Icon | path:assets/media/svg/icons/Communication/Mail-notification.svg&ndash;&gt;<svg
                          xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                          height="24px" viewBox="0 0 24 24" version="1.1">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <rect x="0" y="0" width="24" height="24"/>
        ...
        <circle fill="#000000" opacity="0.3" cx="19.5" cy="17.5" r="2.5"/>
                      ...
                      <div class="d-flex align-items-center mb-6">
                        ...
                        <div class="symbol symbol-40 symbol-light-success mr-5">
                    <span class="symbol-label">
                        <span class="svg-icon svg-icon-lg  svg-icon-success">&lt;!&ndash;begin::Svg Icon | path:assets/media/svg/icons/Design/Bucket.svg&ndash;&gt;<svg
                          xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                          height="24px" viewBox="0 0 24 24" version="1.1">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <rect x="0" y="0" width="24" height="24"/>
            ...
            <ul class="menu-nav ">
              ...
              <a-popover placement="bottom">
                ...
                <li
                  ...
                  data-menu-toggle="hover" aria-haspopup="true"><a href="javascript:;"
                                                                   class="menu-link menu-toggle"><span
                  class="menu-text">Locations</span><span class="menu-desc">All Locations For Skyvx</span><i
                  class="menu-arrow"></i></a>
                </li>
              </a-popover>
              <a-popover placement="bottom">
