...
export type GetAllPricingQuery = (
  ...
  & { pricings?: Maybe<Array<Maybe<(
    { __typename?: 'Pricing' }
    & Pick<Pricing, 'id' | 'nameSlug' | 'base' | 'tax' | 'type'>
  )>>> }
);
